-- лексикографическое дерево (trie) с частотностями в листовых вершинах. 
-- Функция trieBuild :: String -> Trie 
-- преобразовывает текст в 
-- лексикографическое дерево, 
-- а функция trieGet :: Trie -> String -> Int 
-- выдаёт частоту слова (0 если не найдено)
